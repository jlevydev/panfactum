...
export default GenericMemo(function AppTabNavigation<T extends TabConfig> (props: ITabNavigationProps<T>) {
  ...
  return (
    <div className="flex flex-col w-full">
      <div className={`border-b-2 border-solid border-gray-light flex items-center w-full ${nested ? '' : ''}`}>
        <Tabs
          value={segment}

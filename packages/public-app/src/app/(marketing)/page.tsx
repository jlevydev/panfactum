  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col px-8 py-8 md:py-16">
        ...
        <div className="flex flex-row w-full flex-wrap">
          <div className="basis-full md:basis-1/3 flex flex-col p-4 gap-2">
            <PackageLock width="50%" height="66%" className="mx-auto"/>
          ...
          <div className="basis-full md:basis-1/3 flex flex-col p-4 gap-2">
            <SortUp width="50%" height="66%" className="mx-auto"/>
            <p className="text-xl text-center">
              Prioritize issues submitted by subscribers automatically in your Github repository.
            </p>
          </div>
          <div className="basis-full md:basis-1/3 flex flex-col p-4 gap-2">
            <Fingerprint width="40%" height="66%" className="mx-auto"/>
            <p className="text-xl text-center">
      ...
      <div className="bg-neutral flex flex-col px-8 py-8 md:py-16">
        ...
        <div className="flex flex-row w-full flex-wrap">
          <div className="basis-full md:basis-1/3 flex flex-col p-4 gap-2">
            <Globe width="40%" height="66%" className="mx-auto"/>
            <p className="text-xl text-center">
          ...
          <div className="basis-full md:basis-1/3 flex flex-col p-4 gap-2">
            <HandCard width="50%" height="66%" className="mx-auto"/>
            <p className="text-xl text-center">
          ...
          <div className="basis-full md:basis-1/3 flex flex-col p-4 gap-2">
            <CandlestickChart width="40%" height="66%" className="mx-auto"/>
            <p className="text-xl text-center">
